...
const uint8_t bc95InitProcess[] = 
    { ACTION_NONE, ACTION_SYNC, ACTION_CFUN, //ACTION_CMEE, ACTION_CGMI, ACTION_CGMR, 
      /*ACTION_NBAND, ACTION_NCONFIG,*/ACTION_CIMI, ACTION_CGSN, ACTION_CSCON, 
...
uint8_t closeUdp_bc95(NBModule bc95)
{
    ...
    if (bc95_status.UDP_ID[0] < '0' || bc95_status.UDP_ID[0] > '6')
        return 0;
    InitATcmd(&atcmd, AT_NSOCL, LOCAL_UDP_SET, CMD_SET);
